            ...
            <table class="w-full text-sm text-left rtl:text-right mb-10">
                <div class="max-w-md mx-auto">
                    <form action="{{ route('finalizarReserva') }}" method="POST">
                        @csrf
                        <div class="mb-4">
                            <label for="fecha" class="block text-black text-sm font-bold mb-2">Selecciona un
                                día:</label>
                        ...
                        <div class="mb-4">
                            <label for="hora" class="block text-black text-sm font-bold mb-2">Selecciona una
                                hora:</label>
