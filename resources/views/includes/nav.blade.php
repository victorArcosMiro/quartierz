<header class="sticky top-0 z-50 backdrop-blur py-5 bg-white/50 w-screen mx-auto">
    <div class="flex flex-row max-w-screen-lg mx-auto justify-around pr-5">
        <a class="mr-auto" href="{{ route('inicio-show') }}"><img class="w-80" src="../images/LOGO.jpg"
                alt="Logo"></a>
        <nav class="space-x-4 text-base flex flex-row justify-center items-center ml-auto">
            ...
            @if (Route::has('login'))
                <div class="-mx-3 flex flex-1 justify-end">
                    ...
                    @else
                        <a href="{{ route('login') }}"
                            class="rounded-md px-3 py-2 text-xl hover:text-white text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20]  ">
                            Log in
                        </a>
            ...
            <a href="{{ route('carrito.mostrar') }}"><img class="h-8 " src="/images/cart.svg"
                    alt="Carrito de la compra"></a>
