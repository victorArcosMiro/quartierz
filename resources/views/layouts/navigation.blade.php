        ...
        <div class="flex py-6 max-w-screen-lg mx-auto justify-between pr-5">
            ...
            <div class="hidden md:flex md:items-center sm:ms-6 justify-between gap-6">
                <nav class="space-x-4 text-base flex flex-row justify-center gap-3 items-center ml-auto">
                    ...
                    <a href="{{ route('custom-show') }}" class="text-base text-black hover:text-white">Custom</a>
            ...
            <div class="mr-4">
                <a href="{{ route('carrito.mostrar') }}"><img
                        class="inline-flex items-center justify-center p-2 rounded-md text-black hover:text-gray-500  hover:bg-gray-100 focus:outline-none focus:bg-gray-100  focus:text-gray-500 transition duration-150 ease-in-out min-w-10 max-w-10"
                        src="/images/cart.svg" alt="Carrito de la compra"></a>
            </div>
        </div>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden md:hidden">
        <div class="space-y-1 flex flex-col items-start ">
            ...
            <a href="{{ route('inicio-show') }}"
                class="pt-2 pb-3 px-4 text-base text-black w-full hover:bg-white">Inicio</a>

            <a href="{{ route('galeria-show') }}"
                class="pt-2 pb-3 px-4 text-base text-black w-full hover:bg-white">Galería</a>

            <a href="{{ route('custom-show') }}"
                class="pt-2 pb-3 px-4 text-base text-black w-full hover:bg-white">Custom</a>

            <a href="{{ route('sobreNosotros') }}"
                class="pt-2 pb-3 px-4 text-base text-black w-full hover:bg-white ">Sobre Nosotros</a>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                ...
                <div class="space-y-1 flex flex-col items-start ">
                    <a href="{{ route('login') }}"
                class="pt-2 pb-3 px-4 text-base text-black w-full hover:bg-white">Iniciar sesión</a>

                <a href="{{ route('register') }}"
                class="pt-2 pb-3 px-4 text-base text-black w-full hover:bg-white">Registro</a>
                </div>
